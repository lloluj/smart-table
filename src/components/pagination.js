...
export const initPagination = (
  ...
  const updatePagination = (total, { page, limit }) => {
    // @todo: #2.2 — посчитать количество страниц
  ...
  // console.log('DEBUG: Pagination - page:', page, 'rowsPerPage:', rowsPerPage, 'skip:', skip);
  // console.log('DEBUG: Pagination - first 3 rows after slice:', data.slice(skip, skip + rowsPerPage).slice(0, 3));
